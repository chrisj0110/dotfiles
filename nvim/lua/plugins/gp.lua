...
return {
    ...
    config = function()
        ...
        vim.keymap.set("n", "<leader>gg", ":GpChatToggle<cr> | :on<cr>", {desc = "GPT Prompt toggle"})
        vim.keymap.set("n", "<leader>gn", ":GpChatNew vsplit<cr> | :on<cr>", {desc = "GPT Prompt new"})
        vim.keymap.set("v", "<leader>gn", ":<C-u>'<,'>GpChatNew vsplit<cr> | :on<cr>", {desc = "GPT Prompt new"})
        vim.keymap.set("v", "<leader>g[", ":<C-u>'<,'>GpChatPaste<cr> | :on<cr>", {desc = "GPT Prompt paste"})
